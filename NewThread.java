// class to simulate transmission and returns whether transmission was successful or not
                ...
                if (this.NumberOfAttempts < 15) {
                    if (ChannelStatus == INUSE) {
                        ...
                        if (ChannelStatus == FREE && distance == 0) {
                            ...
                            System.out.println("Collision for frame " + FrameNo + " of " + StationNumber + " and frame " + frame + " of Station " + stat);
                    ...
                    SuccTrans.set(true);
                    System.out.println("Too many attempts for frame " + FrameNo + " of " + StationNumber + ". Transmission stopped");
                }
            }
        }
    }
